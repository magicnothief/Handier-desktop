...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/MagicNoThief/Handier-desktop"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("Handier/1.0 (+https://github.com/MagicNoThief/Handier-desktop)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Handier"));
