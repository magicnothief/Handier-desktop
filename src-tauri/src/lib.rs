...
pub fn run(cli_args: CliArgs) {
    ...
    app.run(|app, event| match &event {
        ...
        tauri::RunEvent::Exit => {
            ...
            // The enhancement sidecar is a child process holding the model in
            // memory. Without this it outlives the app and keeps a couple of
            // gigabytes resident until it is killed by hand.
